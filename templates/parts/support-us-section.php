 ...
 * @var \OCP\IL10N $l
 * @var \OCA\InventoryCheck\Support\SupportUsLinks $supportUsLinks
...
if (!isset($supportUsLinks) || !$supportUsLinks instanceof \OCA\InventoryCheck\Support\SupportUsLinks) {
	return;
}
