...
$runners = [
	...
	['file' => 'tests/Mutation/run-stock-issue-facade-mutations.php', 'bucket' => 'hot'],
	['file' => 'tests/Mutation/run-balance-mutations.php', 'bucket' => 'hot'],
	['file' => 'tests/Mutation/run-csv-mutations.php', 'bucket' => 'hot'],
	...
	['file' => 'tests/Mutation/run-dedicated-app-admin-mutations.php', 'bucket' => 'service'],
	['file' => 'tests/Mutation/run-filter-panel-mutations.php', 'bucket' => 'service'],
	...
	['file' => 'tests/Mutation/run-lifecycle-mutations.php', 'bucket' => 'service'],
	...
	['file' => 'tests/Mutation/run-settings-pages-mutations.php', 'bucket' => 'service'],
];
