...
runMutations(dirname(__DIR__, 2), 'MovementMathTest', [
	['name' => 'qty-min-zero', 'file' => $file, 'search' => 'return $qty >= self::QTY_MIN && $qty <= $max;', 'replace' => 'return $qty > self::QTY_MIN && $qty <= $max;'],
	['name' => 'qty-max-open', 'file' => $file, 'search' => 'return $qty >= self::QTY_MIN && $qty <= $max;', 'replace' => 'return $qty >= self::QTY_MIN && $qty < $max;'],
