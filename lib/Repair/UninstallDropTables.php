 ...
 *
 * Drops every table the inventorycheck app has ever created, migration rows, and app config.
 *
 ...
 *     php scripts/check-nextcloud-db-standards.php sync-uninstall --app=inventorycheck
 *
...
final class UninstallDropTables implements IRepairStep
{
	...
	{
		return 'Drop inventorycheck tables and install metadata on uninstall';
	}
	...
	public function run(IOutput $output): void
	{
		...
		$output->info(
			'inventorycheck: preserving data on disable. '
