 ...
 *
 * Regenerate via:
 *     php scripts/sync-upgrade-backup.php --app=inventorycheck
 */
...
final class UpgradeBackupCatalog
{
	...
	/** @var list<string> App-data folder names (under appdata_<instance>/inventorycheck/) to include in snapshots. */
